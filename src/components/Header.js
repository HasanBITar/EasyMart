...
import { signIn, signOut, dashboard, useSession } from "next-auth/react";
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        <form
          className="hidden sm:flex items-center h-10 rounded-md flex-grow bg-purple-400 hover:bg-purple-500 hover:cursor-pointer"
          ...
          {session && session.user.name === 'admin' ? (
            ...
            <>
              ...
              <div
                ...
                className="relative Link flex items-center border border-amazon_blue  hover:border-white"
              >
                <span className="absolute right-0 top-0 md:right-10 h-4 w-4 bg-purple-400 rounded-full font-extrabold text-black text-center">
                  {count}
                </span>
